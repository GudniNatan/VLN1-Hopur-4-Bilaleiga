...
class Repository(ABC):
    ...
    def update(self, model_object: _TYPE):
        ...
        CSVObjectNotFoundError if an object with the given key is not found.'''
    ...
    def get(self, key):
        '''Return the object with the given key. Raises CSVObjectNotFoundError
