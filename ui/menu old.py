...
class Menu(object):
    ...
    def set_options(self, options):
        ...
        for option in options:
            if type(option) == tuple:
                ...
                self.__options.append((counter, option))
                counter += 1
    ...
    def get_input(self):
        ...
        return (
            self.__options[cursor][0],
            [input_line.get_input() for input_line in self.__input_lines]
            )
